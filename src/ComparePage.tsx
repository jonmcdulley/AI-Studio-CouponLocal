...
const COMPARE_DATA = {
  ...
  Fashion: [
    ...
    { store: "Charles & Keith PH", offer: "Up to 3.5% Cashback", description: "Latest bags, shoes & accessories.", logo: "https://www.google.com/s2/favicons?domain=charleskeith.com&sz=64", affiliateUrl: "https://invl.me/clnfk9t", commission: 3.5 },
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative mb-8">
          <input
            type="text"
            placeholder="Search deals across all stores (e.g. flights, fashion, beauty...)"
            value={search}
          ...
          />
          {search && (
            <button onClick={() => setSearch("")} className="absolute right-4 top-4 text-gray-400 hover:text-gray-600 text-xl">✕</button>
          )}
        </div>
        ...
        {!search.trim() && (
          <>
            ...
            {/* Comparison Table */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {COMPARE_DATA[activeCategory as keyof typeof COMPARE_DATA]
