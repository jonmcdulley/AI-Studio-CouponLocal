          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="h-24 flex items-center justify-center overflow-hidden">
                <img src="/logo.png" alt="Coupon Hunter" className="h-full w-auto object-contain" referrerPolicy="no-referrer" />
              </div>
            </div>
            <div className="flex items-center gap-2">
              <motion.button
              ...
              <motion.button 
                ...
                className={cn(
                  "flex items-center gap-1.5 text-sm font-medium transition-all group/loc px-3 py-1.5 rounded-full border",
                  !location && !isEditingLocation
                    ? "bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-200" 
                    : "text-gray-500 bg-gray-50 border-gray-100 hover:bg-indigo-50 hover:border-indigo-200 cursor-pointer"
                )}
              >
                <MapPin size={14} className={cn(
                  "transition-transform group-hover/loc:scale-110",
                  !location && !isEditingLocation ? "text-white" : "text-indigo-500"
                )} />
                {isEditingLocation ? (
                  <div className="relative" onClick={(e) => e.stopPropagation()}>
                    ...
                    >
                      <input 
                        ...
                        type="text"
                        className={cn(
                          "bg-transparent border-none focus:ring-0 p-0 text-sm w-[120px] font-medium",
                          !location ? "text-white placeholder:text-white/70" : "text-indigo-600"
                        )}
                  ...
                  <span className="truncate max-w-[150px]">
                    {isLocating ? 'Locating...' : (location ? `City: ${location}` : 'Set Location')}
                  </span>
                )}
              </motion.button>
              <button
